...
class DaliliApplication : Application() {
    ...
    private suspend fun seedInitialDataIfNeeded() {
        // Checking if we already have categories seeded
    ...
    private suspend fun seedServiceProviders() {
        val providers = listOf(
            ...
            ServiceProvider(
                ...
                descriptionAr = "فحص متكامل لجميع أنواع السيارات بالكمبيوتر وصيانة المحركات وبرمجة المنظومات الحديثة.",
        ...
        for (provider in providers) {
            database.serviceProviderDao().insertProvider(provider)
        }
    }
}
